    ...
    return (
        <nav className={`fixed top-0 left-0 w-full flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 transition-all duration-500 z-50 ${isScrolled ? "bg-black/80 backdrop-blur-md shadow-md py-3 md:py-4" : "bg-transparent py-4 md:py-6"}`}>
            ...
            <div className="hidden md:flex items-center gap-4">
                <Link to="/login" className="bg-white text-black px-6 py-2 rounded-full font-medium hover:bg-gray-100 transition-colors">
                    Login
                </Link>
            </div>
            ...
            {/* Mobile Menu */}
            <div className={`fixed top-0 left-0 w-full h-screen bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 text-white flex flex-col md:hidden items-center justify-center gap-8 font-medium text-lg transition-all duration-500 ${isMenuOpen ? "translate-x-0" : "-translate-x-full"}`}>
                <button 
